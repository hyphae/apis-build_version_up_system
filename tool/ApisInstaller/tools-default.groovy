...
if (args.length < 20) {
    println "Usage: groovy tools-default.groovy -a <apis> -e <expFile> -c <count> -sp <sshPassphrase> -i <interface> -v <version> -f <copXmlFileName> -cop \"all\"|\"first\"|<unitId> -ld <logDir> -wd <workDir>"
    System.exit(1)
}
