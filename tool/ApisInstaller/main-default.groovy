...
if (args.length < 18) {
    println "Usage: groovy main-default.groovy -e <expFile> -c <count> -sp <sshPassphrase> -i <interface> -v <version> -f <copXmlFileName> -cop \"all\"|\"first\"|<unitId> -ld <logDir> -wd <workDir>"
    System.exit(1)
}
