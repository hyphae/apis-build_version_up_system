...
if (args.length < 18) {
    println "Usage: groovy main-globaloperationmode.groovy -e <expFile> -c <count> -sp <sshPassphrase> -i <interface> -v <version> -f <copXmlFileName> -cop \"all\"|\"first\"|<unitId> -ld <logDir> -m <mode>"
    System.exit(1)
}
